...
- The Comp function is restricted to return one of the comparison categories, and nothing else.
...
E.g. sort_three_way() may report that the resulted sorted range is either sorted from smallest to largest (or largest to smallest), all element are equal or even 
...
> |    concept same-as-any-of = (std::same_as<T, U> or ...); // exposition only
> |
> |    template<
> |        input_iterator I1,
> |        input_iterator I2,
...
# Acknowledgements
    ...
    Mor Almalach <Mor.Elmaliach@beyeonics.com>
